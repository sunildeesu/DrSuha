      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <AnimateOnScroll animation="fadeInUp" delay={150}>
          <div className="max-w-2xl mx-auto">
            <div className="bg-cream rounded-2xl p-8 md:p-12 border border-cream-dark text-center">
              {/* Google Logo */}
              <div className="flex items-center justify-center gap-2 mb-4">
                ...
                <span className="text-charcoal font-medium text-sm">Google Reviews</span>
              </div>
              ...
              <p className="text-warm-gray leading-relaxed mb-8 max-w-md mx-auto">
                We value honest feedback from every patient. Your experience
                helps others take the first step toward better mental health.
              </p>
              ...
              <a
                ...
                className="inline-flex items-center gap-2 bg-white text-charcoal px-8 py-3.5 rounded-full font-medium border border-cream-dark hover:border-sage hover:text-sage transition-all duration-300 shadow-sm"
              >
              ...
              <p className="text-warm-gray/60 text-xs mt-4">
                Once you have a Google Business listing, real patient reviews will appear here automatically.
              </p>
            </div>
          </div>
        </AnimateOnScroll>
